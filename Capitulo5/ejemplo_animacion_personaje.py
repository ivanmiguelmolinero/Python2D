#-------------------------------------------------------------------------------
# Name:        ejemplo_animacion_personaje
# Purpose:
#
# Author:      ivijo
#
...
class MiPersonaje(MiObjeto):
    ...
    def update(self, delta_t):
        ...
        if not pulsadas[key.RIGHT] and not pulsadas[key.LEFT]:
            self.image = load('./Capitulo5/fotograma_base.png')
            self.pulsado = False
...
class MiCapa(ColorLayer):
    ...
    def __init__(self):
        ...
        mi_secuencia = ImageGrid(load('./Capitulo5/fotogramas_dcha.png'), 2, 2)
        mi_secuencia2 = ImageGrid(load('./Capitulo5/fotogramas_izqda.png'), 2, 2)
