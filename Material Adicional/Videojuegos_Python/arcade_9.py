...
class MiMisil(MiObjeto):
    ...
    def update(self, delta_t):
        ...
        if pulsadas[key.SPACE] and self.esta_lanzado == False:
            ...
            sonido_misil.sound.set_volume(0.1)
            sonido_misil.play()
...
class MiCapa(Layer):
    ...
    def __init__(self, HUD):
        ...
        musica_de_fondo = Effect('.\GameLoops\MelodicHouse_1.wav')
        musica_de_fondo.sound.set_volume(0.1)
        musica_de_fondo.sound.play(-1)

        self.image = Sprite(load('universo_2.jpg'), (400,325))
    ...
    def collide(self, node):
        if node is not None:
            for other in self.man_col.iter_colliding(node):
                ...
                sonido_explosion.sound.set_volume(0.05)
