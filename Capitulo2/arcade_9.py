...
class MiAlien(MiObjeto):
    def __init__(self, img, x, y):
        ...
        self.velocidad = Vector2(vel_alien, 0)
        self.contador = 0
        self.dir = choice([-1, 1])
...
class MiCapa(Layer):
    ...
    def __init__(self, HUD):
        ...
        self.image = Sprite(load('./Capitulo2/universo_2.jpg'), (400, 325))
    ...
    def crear_misil(self):
        ...
        self.misil.TECLAS_PULSADAS[key.SPACE] = 0
        self.add(self.misil, z = 1)
...
class MiHUD(Layer):
    ...
    def update(self):
        ...
        texto_nivel = 'Nivel: ' + str(self.nivel)
        etiqueta_nivel = MiEtiqueta(texto_nivel, 365, 640)
        self.add(etiqueta_vidas)
        self.add(etiqueta_puntos)
        self.add(etiqueta_nivel)
        if self.vidas == 0:
            pygame.mixer.music.stop()
