#-------------------------------------------------------------------------------
# Name:        ejemplo_movimiento_esfera_limitado
# Purpose:
#
# Author:      ivijo
#
...
class MiCapa(cocos.layer.Layer):
    ...
    def __init__(self):
        super().__init__()
        self.mi_actor = Actor('./Capitulo1/mi_esfera.png', 320, 240)
    ...
    def update(self, dt):
        ...
        if x != 0 or y!= 0:
            ...
            if self.mi_actor.width / 2 < nueva_x < cocos.director.director.window.width - self.mi_actor.width / 2 and\
                self.mi_actor.height / 2 < nueva_y < cocos.director.director.window.height - self.mi_actor.height / 2:
